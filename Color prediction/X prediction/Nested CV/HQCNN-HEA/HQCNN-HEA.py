...
# ======================================================
# Deterministic Reproducibility Setup
# ======================================================
SEED = 42
...
# ======================================================
# Quantum Layer Setup (Enhanced HEA Ansatz)
# ======================================================
n_qubits = X.shape[1]
n_layers = 4
...
def enhanced_hea(inputs, scale, shift, rot):
    # Parameterized feature encoding with learnable scale and shift
    for i in range(n_qubits):
        qml.RY(inputs[i] * scale[i] + shift[i], wires=i)

    # Variational layers with full SU(2) rotations and all-to-all CNOT entanglement
...
for fold, (train_idx, test_idx) in enumerate(outer_cv.split(X)):
    ...
    # ==================================================
    # Final Model Retraining on Outer Fold Training Set
    # ==================================================
