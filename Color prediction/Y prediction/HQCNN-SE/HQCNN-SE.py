...
# Suppress Optuna info/warning logs and re-seed NumPy/random
...
# Extract feature matrix X and target vector y (excluding non-feature and target columns)
...
# Top-level undecomposed quantum circuit diagram
...
# Device-level decomposed quantum circuit diagram
...
# Final hybrid neural network architecture
...
# Diagonal reference line y = x across the defined range
...
# Equal aspect ratio for geometric alignment
