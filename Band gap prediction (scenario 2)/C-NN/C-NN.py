...
class ClassicalQuantumLayer(nn.Module):
    """
    Classical feed-forward approximation of a quantum parameterized circuit:
    Consists of stacked Linear layers with Tanh activation functions.
    """
...
def objective(trial):
    ...
    # Hybrid NN architecture with Classical-Quantum equivalent block
...
def plot_nn_professional_save(layer_sizes, filename="NN_architecture.png"):
    ...
    radius = 0.3
    font_size = 10
    vertical_text_offset = 2.0  # Increased vertical spacing for labels
    ...
    for i, n_neurons in enumerate(layer_sizes):
        ...
        # Layer text annotations with vertical offset
