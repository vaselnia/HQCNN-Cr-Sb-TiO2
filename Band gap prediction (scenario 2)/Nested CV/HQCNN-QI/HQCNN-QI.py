...
# Initial train-test split for Optuna hyperparameter optimization
...
# Compile QNode into a PyTorch-compatible TorchLayer
...
# Run Optuna study to find the best configuration
...
for fold, (tr_idx, te_idx) in enumerate(kf.split(X_scaled), 1):
    ...
    # Full 100-epoch training per CV fold
    for _ in range(100):
        model.train()
        for bx, by in loader:
            optimizer.zero_grad()
